        ...
        <div className="col-lg-8">
          <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div
              ...
              style={{
                height: '280px',
                backgroundImage: course.bannerUrl ? `url(${course.bannerUrl})` : 'linear-gradient(135deg, #d1fae5, #a7f3d0)',
            ...
            >
              {!course.bannerUrl && (
                <div className="h-100 d-flex align-items-center justify-content-center text-success">
                  <i className="bi bi-journal-richtext" style={{ fontSize: '4rem' }}></i>
                </div>
              )}
            </div>
