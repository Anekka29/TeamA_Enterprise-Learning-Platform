...
const TOOLS_REGISTRY = {
  ...
  MENTOR: [
    ...
    { title: 'Mentor Metrics & Analytics', category: 'Analytics', icon: 'bi-graph-up-arrow', href: '/mentor-dashboard#mentor-analytics', keywords: 'metrics ratings reviews revenue views engagement' },
  ...
  ADMIN: [
    ...
    { title: 'Platform Health Monitor', category: 'System', icon: 'bi-activity', href: '/admin-dashboard#monitoring', keywords: 'monitor server health db uptime memory logs performance' },
    ...
    { title: 'CMS & Content Control', category: 'CMS', icon: 'bi-file-richtext', href: '/admin-dashboard#cms', keywords: 'cms banners announcements landing page content' },
