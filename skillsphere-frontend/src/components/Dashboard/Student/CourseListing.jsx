    ...
    <div className="fade-in-quick">
      ...
      <div className="card border-0 shadow-sm rounded-4 p-3 mb-4">
        <div className="row g-3 align-items-center">
          ...
          <div className="col-md-2 d-flex justify-content-end gap-1 flex-wrap">
            {['All', 'Tech', 'Design', 'Business'].map(cat => (
              <button
                key={cat}
                className={`btn btn-sm px-2 rounded-pill fw-bold ${filter === cat ? 'btn-success' : 'btn-light border text-muted'}`}
                ...
                >
                  {!course.thumbnailUrl && (
                    <div className="h-100 d-flex align-items-center justify-content-center text-success">
                      <i className="bi bi-journal-richtext" style={{ fontSize: '2rem' }}></i>
                    </div>
                  )}
                </div>
