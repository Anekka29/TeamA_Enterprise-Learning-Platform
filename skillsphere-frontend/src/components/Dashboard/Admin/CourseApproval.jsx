        ...
        <div className="col-lg-4">
          <div className="rounded-4 border bg-light overflow-hidden position-relative d-flex align-items-center justify-content-center" style={{ minHeight: '240px', maxHeight: '280px' }}>
            {course.thumbnailUrl ? (
              ...
              <div className="h-100 d-flex flex-column align-items-center justify-content-center text-muted p-4">
                <i className="bi bi-card-image fs-1 mb-2 text-secondary"></i>
                <span className="fw-semibold">Thumbnail not provided</span>
              </div>
            )}
          </div>
          ...
          {course.bannerUrl && (
            <div className="mt-3">
              ...
              <div className="rounded-4 border bg-light overflow-hidden" style={{ height: '120px', backgroundImage: `url(${course.bannerUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
            </div>
          )}
        ...
        {canTakeReviewActions && (
          <>
            <button type="button" className="btn btn-success rounded-pill fw-bold px-4" onClick={onApprove} disabled={busyAction !== ''}>
              {busyAction === 'approve' ? 'Approving...' : 'Approve Course'}
            </button>
  ...
  return (
    ...
    >
      <div className="study-window bg-white rounded-4 p-4 text-start shadow-lg" style={{ maxWidth: '460px', width: '92%' }}>
        <h5 className="fw-bold text-dark mb-2">Approve this course?</h5>
        <p className="text-muted small mb-4">
          Are you sure you want to approve and publish <strong>"{courseTitle}"</strong>? It will instantly become active across student dashboards, search, and landing pages.
        </p>
