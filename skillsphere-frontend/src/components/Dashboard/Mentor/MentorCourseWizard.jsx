          ...
          <div className="row g-3">
            ...
            <div className="col-md-6">
              <MediaUploader
                ...
                onChange={(url) => updateCourseField('thumbnailUrl', url)}
                label="Course Thumbnail"
                description="Upload a high-quality thumbnail image for your course catalog display."
                onShowToast={onShowToast}
              />
              <FieldError error={courseErrors.thumbnailUrl} />
            </div>
            <div className="col-md-6">
              <MediaUploader
                type="image"
                value={course.bannerUrl}
                onChange={(url) => updateCourseField('bannerUrl', url)}
                label="Course Banner"
                description="Upload a wide banner image shown at the top of your course landing page."
                onShowToast={onShowToast}
              />
              <FieldError error={courseErrors.bannerUrl} />
            </div>
            <div className="col-md-6">
              <MediaUploader
                type="video"
