export const STUDENT_SIDEBAR_LINKS = [
  ...
  { icon: 'bi-chat-left-text-fill', label: 'Forum', href: '/student-dashboard#discussion' },
  { icon: 'bi-bar-chart-line-fill', label: 'Analytics', href: '/student-dashboard#progress' },
  { icon: 'bi-trophy-fill', label: 'Leaderboard', href: '/student-dashboard#leaderboard' },
...
export const MENTOR_SIDEBAR_LINKS = [
  ...
  { icon: 'bi-graph-up-arrow', label: 'Metrics', href: '/mentor-dashboard#mentor-analytics' },
...
export const ADMIN_SIDEBAR_LINKS = [
  ...
  { icon: 'bi-chat-left-text-fill', label: 'Tickets', href: '/admin-dashboard#complaints' },
  { icon: 'bi-activity', label: 'Monitor', href: '/admin-dashboard#monitoring' },
  { icon: 'bi-shield-lock-fill', label: 'Audits', href: '/admin-dashboard#audits' },
  { icon: 'bi-file-richtext', label: 'CMS', href: '/admin-dashboard#cms' },
