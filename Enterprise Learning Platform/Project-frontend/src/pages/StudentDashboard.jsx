    ...
    <div className={`dashboard-wrapper-sim ${themeMode === 'dark' ? 'dark-theme-active' : ''}`}>
      ...
      >
                  ...
                  <div className="card border-0 shadow-sm rounded-4 p-4 mb-4 text-start bg-white">
                    ...
                    <div className="p-3 bg-light rounded-4 border d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                      ...
                      <button
                        ...
                        onClick={() => navigate(`/student-dashboard/courses/${continueLearningCourse.courseId || continueLearningCourse.id}`, { state: { autoPlay: true } })}
                      >
                            ...
                            <div className="d-flex align-items-center gap-3 ms-auto">
                              ...
                              {(course.progress || 0) >= 100 ? (
                                ...
                                <button
                                  ...
                                  style={{ fontSize: '0.78rem', whiteSpace: 'nowrap' }}
                                  onClick={() => navigate(`/student-dashboard/courses/${course.courseId || course.id}`, { state: { autoPlay: true } })}
                                >
                                  Continue
                                </button>
                              )}
        ...
        {activeTab === '#progress' && (
          <Analytics
            dashboard={dashboard}
            enrollments={displayEnrolledCourses}
          />
        )}
