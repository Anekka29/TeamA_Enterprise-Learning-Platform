...
export const EXTERNAL_PRACTICE_QUIZZES = [
  {
    id: 'ext-py-1',
    title: 'HackerRank Python Certification & Practice Track',
    courseCategory: 'Python',
    platform: 'HackerRank',
    platformIcon: 'bi-code-square',
    badgeColor: '#2ec4b6',
    bgColor: '#f0fdfa',
    borderColor: '#ccfbf1',
    difficulty: 'All Levels',
    estimatedTime: '30 mins / set',
    totalQuestions: '50+ Challenges',
    url: 'https://www.hackerrank.com/domains/python',
    description: 'Solve interactive Python challenges from basic syntax, data structures (lists, tuples, sets), string manipulations to math and Object-Oriented Programming.',
    features: ['Instant Code Execution', 'Automated Testcases', 'Skill Badges'],
    recommendedFor: 'Python Programming - Beginner to Advanced'
  },
  {
    id: 'ext-py-2',
    title: 'LeetCode Python 75 & Algorithmic Practice Plan',
    courseCategory: 'Python',
    platform: 'LeetCode',
    platformIcon: 'bi-terminal-fill',
    badgeColor: '#f59e0b',
    bgColor: '#fffbeb',
    borderColor: '#fef3c7',
    difficulty: 'Intermediate',
    estimatedTime: '45 mins / set',
    totalQuestions: '75+ Problems',
    url: 'https://leetcode.com/studyplan/leetcode-75/',
    description: 'Master core algorithmic problem-solving in Python. Practice Arrays, HashMaps, Two Pointers, Dynamic Programming, and Binary Trees.',
    features: ['Industry Interview Prep', 'Big-O Complexity Metrics', 'Discussion Forums'],
    recommendedFor: 'Python Programming - Beginner to Advanced'
  },
  {
    id: 'ext-py-3',
    title: 'W3Schools Python Interactive Quiz & Knowledge Check',
    courseCategory: 'Python',
    platform: 'W3Schools',
    platformIcon: 'bi-patch-check-fill',
    badgeColor: '#059669',
    bgColor: '#ecfdf5',
    borderColor: '#d1fae5',
    difficulty: 'Beginner',
    ...
    description: 'Test your understanding of Python syntax, functions, modules, file handling, and regex in quick interactive multiple-choice quizzes.',
    features: ['Instant Score Feedback', 'Detailed Explanations', 'Beginner Friendly'],
    recommendedFor: 'Python Programming - Beginner to Advanced'
  },
  {
    id: 'ext-py-4',
    title: 'Real Python Interactive Quizzes & Deep Dives',
    courseCategory: 'Python',
    platform: 'Real Python',
    platformIcon: 'bi-filetype-py',
    badgeColor: '#3b82f6',
    bgColor: '#eff6ff',
    borderColor: '#dbeafe',
    difficulty: 'Advanced',
    ...
    description: 'Test your knowledge on Python OOP, Decorators, Generators, AsyncIO, and FastAPI backend architecture with expert explanation breakdowns.',
    features: ['Deep Conceptual Focus', 'Code Snippet Analysis', 'Expert Tips'],
    recommendedFor: 'Python Programming - Beginner to Advanced'
  },
  {
    id: 'ext-java-1',
    title: 'GeeksforGeeks Java Practice & Quiz Hub',
    courseCategory: 'Java',
    platform: 'GeeksforGeeks',
    platformIcon: 'bi-cpu-fill',
    badgeColor: '#16a34a',
    bgColor: '#f0fdf4',
    borderColor: '#bbf7d0',
    difficulty: 'All Levels',
    ...
    url: 'https://www.geeksforgeeks.org/java-gq/',
    description: 'Comprehensive quiz sets covering Core Java, Collections, Multithreading, JVM Architecture, and Object-Oriented Design Patterns.',
    features: ['Topic-wise Quizzes', 'Interview Frequency Tags', 'Explanation Notes'],
    recommendedFor: 'Java Programming Fundamentals'
  },
  {
    id: 'ext-java-2',
    title: 'HackerRank Java Language Track',
    courseCategory: 'Java',
    platform: 'HackerRank',
    platformIcon: 'bi-code-square',
    badgeColor: '#2563eb',
    ...
    totalQuestions: '30+ Challenges',
    url: 'https://www.hackerrank.com/domains/java',
    description: 'Practice Java String manipulations, Big Integer, Exception Handling, Data Structures (Map, Stack, Deque), and File I/O.',
    features: ['Compiler Verification', 'Official Skill Certificates', 'Enterprise Prep'],
    recommendedFor: 'Java Programming Fundamentals'
  },
  {
    id: 'ext-dm-1',
    title: 'Google Digital Garage Knowledge Assessment',
    courseCategory: 'Marketing',
    platform: 'Google',
    platformIcon: 'bi-google',
    badgeColor: '#ea4335',
    bgColor: '#fef2f2',
    borderColor: '#fee2e2',
    difficulty: 'All Levels',
    ...
    totalQuestions: '20 Questions',
    url: 'https://skillshop.exceedlms.com/student/catalog/browse?category_ids=53-google-ads',
    description: 'Official practice tests from Google on Digital Marketing Fundamentals, Search Engine Indexing, Google Analytics 4, and Ads Strategy.',
    features: ['Official Google Standards', 'Practical Case Studies', 'Industry Recognized'],
    recommendedFor: 'Digital Marketing and SEO Mastery'
  },
  {
    id: 'ext-dm-2',
    title: 'HubSpot Academy SEO & Content Marketing Quizzes',
    courseCategory: 'Marketing',
    platform: 'HubSpot',
    platformIcon: 'bi-diagram-2-fill',
    badgeColor: '#ff7a59',
    bgColor: '#fff7ed',
    borderColor: '#ffedd5',
    difficulty: 'Intermediate',
    estimatedTime: '20 mins',
    totalQuestions: '15 Questions',
    url: 'https://academy.hubspot.com/courses/seo-training',
    description: 'Test your knowledge on Search Engine Optimization, Technical On-Page Audits, Link Building, and Inbound Content Marketing Funnels.',
    features: ['Inbound Marketing Focus', 'Interactive Practice Sets', 'Free Access'],
    recommendedFor: 'Digital Marketing & Content Marketing'
  },
  {
    id: 'ext-cm-1',
    title: 'Copyblogger Persuasive Copywriting Quiz',
    courseCategory: 'Marketing',
    platform: 'Copyblogger',
    platformIcon: 'bi-pen-fill',
    badgeColor: '#8b5cf6',
    bgColor: '#f5f3ff',
    borderColor: '#ddd6fe',
    difficulty: 'Intermediate',
    ...
    description: 'Evaluate your understanding of AIDA copywriting formulas, headline psychology, call-to-actions (CTAs), and high-converting landing page text.',
    features: ['Conversion Focus', 'Headline Writing Tips', 'Real Examples'],
    recommendedFor: 'Content Marketing and Copywriting'
  },
  {
    id: 'ext-soft-1',
    title: 'MindTools Professional Communication Self-Assessment',
    courseCategory: 'Soft Skills',
    platform: 'MindTools',
    platformIcon: 'bi-chat-quote-fill',
    badgeColor: '#0284c7',
    bgColor: '#f0f9ff',
    borderColor: '#e0f2fe',
    difficulty: 'All Levels',
    estimatedTime: '15 mins',
    totalQuestions: '15 Questions',
    url: 'https://www.mindtools.com/a42b1yd/how-good-are-your-communication-skills',
    description: 'Professional self-assessment quiz on Executive Presence, Active Listening, Vocal Dynamics, and Public Speaking Confidence.',
    features: ['Personalized Feedback', 'Score Analysis', 'Actionable Steps'],
    recommendedFor: 'Effective Communication and Public Speaking'
  },
  {
    id: 'ext-3d-1',
    title: 'CG Cookie 3D Mesh Modeling & Shader Quiz',
    courseCategory: 'Design',
    platform: 'CG Cookie',
    platformIcon: 'bi-box-seam-fill',
    badgeColor: '#ec4899',
    bgColor: '#fdf2f8',
    borderColor: '#fce7f3',
    difficulty: 'Intermediate',
    ...
    description: 'Practice quiz on polygon mesh topography, UV unwrapping, procedural PBR shaders, camera framing, and keyframe animation.',
    features: ['3D Pipeline Focus', 'Visual Diagrams', 'Blender & Maya Prep'],
    recommendedFor: '3D Animation and Modeling'
  }
];
...
export default function QuizAttempt({ onShowToast }) {
  ...
  // External Quizzes Hub Tabs & Filters
  const [activeQuizTab, setActiveQuizTab] = useState('internal');
  const [selectedExtCategory, setSelectedExtCategory] = useState('ALL');
  const [loggedExternalIds, setLoggedExternalIds] = useState(() => {
    try {
      const saved = localStorage.getItem('skillsphere_logged_ext_quizzes');
  ...
  const handleLogExternalPractice = (quiz) => {
    const nextSet = new Set(loggedExternalIds);
    nextSet.add(quiz.id);
    setLoggedExternalIds(nextSet);
    try {
      localStorage.setItem('skillsphere_logged_ext_quizzes', JSON.stringify(Array.from(nextSet)));
      const currXP = parseInt(localStorage.getItem('skillsphere_student_xp') || '450', 10);
      localStorage.setItem('skillsphere_student_xp', (currXP + 25).toString());
    } catch (e) {}

    if (onShowToast) {
      onShowToast('success', `Practice logged for ${quiz.platform}! +25 XP awarded.`);
    }
  };
    ...
    <div className="fade-in-quick text-start">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
          ...
          <p className="text-muted mb-0">Test your skills with mentor quizzes or practice on top online industry platforms.</p>
        </div>
        <div className="d-flex gap-2 align-items-center">
          <span className="badge bg-success-subtle text-success border border-success-subtle px-3 py-2 rounded-pill fw-bold">
            <i className="bi bi-award-fill me-1"></i> {allAvailableQuizzes.length} System Quizzes
          </span>
          <span className="badge bg-primary-subtle text-primary border border-primary-subtle px-3 py-2 rounded-pill fw-bold">
            <i className="bi bi-globe2 me-1"></i> {EXTERNAL_PRACTICE_QUIZZES.length} External Practice Sets
          </span>
        </div>
      </div>

      {/* QUIZ SECTION SUB-TABS */}
      <div className="d-flex gap-2 mb-4 border-bottom pb-3 flex-wrap">
        <button
          className={`btn rounded-pill px-4 py-2 fw-bold d-flex align-items-center gap-2 ${activeQuizTab === 'internal' ? 'btn-success text-white shadow-sm' : 'btn-light text-secondary border'}`}
          onClick={() => setActiveQuizTab('internal')}
        >
          <i className="bi bi-person-workspace"></i>
          Mentor & System Quizzes ({allAvailableQuizzes.length})
        </button>
        <button
          className={`btn rounded-pill px-4 py-2 fw-bold d-flex align-items-center gap-2 ${activeQuizTab === 'external' ? 'btn-primary text-white shadow-sm' : 'btn-light text-secondary border'}`}
          onClick={() => setActiveQuizTab('external')}
        >
          <i className="bi bi-globe2"></i>
          External Professional Practice Hub ({EXTERNAL_PRACTICE_QUIZZES.length})
          <span className="badge bg-warning text-dark rounded-pill ms-1" style={{ fontSize: '0.68rem' }}>TOP PLATFORMS</span>
        </button>
      </div>

      {/* TAB 1: INTERNAL & MENTOR QUIZZES */}
      {activeQuizTab === 'internal' && (
        <div className="mb-5">
      ...
      {/* TAB 2: EXTERNAL PROFESSIONAL PRACTICE HUB */}
      {activeQuizTab === 'external' && (
        <div className="mb-5">
          {/* External Category Filter Pills */}
          <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <h5 className="fw-bold text-dark mb-0 d-flex align-items-center gap-2">
              <i className="bi bi-award-fill text-warning"></i>
              Online Practice Sets by Domain
            </h5>
            <div className="d-flex gap-2 flex-wrap">
              {['ALL', 'Python', 'Java', 'Marketing', 'Soft Skills', 'Design'].map((cat) => (
                <button
                  key={cat}
                  onClick={() => setSelectedExtCategory(cat)}
                  className={`btn btn-sm rounded-pill px-3 fw-bold ${selectedExtCategory === cat ? 'btn-dark text-white' : 'btn-light border text-muted'}`}
                >
          ...
          <div className="row g-4">
            {EXTERNAL_PRACTICE_QUIZZES
              .filter(q => selectedExtCategory === 'ALL' || q.courseCategory.toLowerCase() === selectedExtCategory.toLowerCase())
              .map((quiz) => {
                const isLogged = loggedExternalIds.has(quiz.id);
                ...
                return (
                  <div key={quiz.id} className="col-lg-6">
                    <div 
                      ...
                      style={{ 
                        background: `linear-gradient(135deg, ${quiz.bgColor} 0%, #ffffff 100%)`,
                        borderLeft: `5px solid ${quiz.badgeColor}`
                      }}
                    >
                      <div className="d-flex justify-content-between align-items-start mb-3">
                        <div className="d-flex align-items-center gap-3">
                          <div 
                            className="rounded-4 p-3 d-flex align-items-center justify-content-center text-white shadow-sm"
                            style={{ backgroundColor: quiz.badgeColor, width: '54px', height: '54px' }}
                          >
                            <i className={`${quiz.platformIcon} fs-2`}></i>
                          </div>
                          <div>
                            <div className="d-flex align-items-center gap-2 mb-1">
                              <span className="badge rounded-pill fw-bold px-3 py-1" style={{ backgroundColor: `${quiz.badgeColor}20`, color: quiz.badgeColor }}>
                                {quiz.platform}
                              </span>
                              <span className="badge bg-light text-dark border rounded-pill small fw-semibold">
                                {quiz.difficulty}
                              </span>
                            </div>
                            <h5 className="fw-bold text-dark mb-0">{quiz.title}</h5>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mb-2">
                        <small className="text-success fw-bold d-flex align-items-center gap-1">
                          <i className="bi bi-book-half"></i> Recommended for: {quiz.recommendedFor}
                        </small>
                      </div>
                      ...
                      <div className="d-flex gap-2 mb-3 flex-wrap">
                        {quiz.features.map((feat, idx) => (
                          <span key={idx} className="badge bg-white text-secondary border rounded-pill px-3 py-1 small">
                            <i className="bi bi-check2-circle me-1 text-success"></i>{feat}
                          </span>
                        ))}
                      </div>
                      ...
                      <div className="d-flex align-items-center gap-3 text-muted small mb-4">
                        ...
                        {isLogged && (
                          <span className="badge bg-success-subtle text-success px-3 py-2 rounded-3 border border-success-subtle fw-bold ms-auto">
                            <i className="bi bi-check-circle-fill me-1"></i> Logged (+25 XP)
                          </span>
                        )}
                      </div>
                      ...
                      <div className="d-flex gap-2">
                        <a
                          ...
                          className="btn flex-grow-1 rounded-pill fw-bold py-2 text-white shadow-sm d-flex align-items-center justify-content-center gap-2"
                          style={{ backgroundColor: quiz.badgeColor, textDecoration: 'none' }}
                        >
                          <i className="bi bi-box-arrow-up-right"></i>
                          Practice Now on {quiz.platform}
                        </a>
                        <button
                          onClick={() => handleLogExternalPractice(quiz)}
                          disabled={isLogged}
                          className={`btn rounded-pill px-3 fw-bold d-flex align-items-center gap-1 ${isLogged ? 'btn-light border text-muted' : 'btn-outline-success'}`}
                          title="Log external practice session to earn XP"
                        >
                          <i className={`bi ${isLogged ? 'bi-check-all text-success' : 'bi-award'}`}></i>
                          {isLogged ? 'Completed' : '+25 XP'}
                        </button>
                      </div>
                    </div>
                  </div>
