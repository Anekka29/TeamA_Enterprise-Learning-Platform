...
export const EXTERNAL_INTERNSHIPS = [
  {
    id: 'ext-int-1',
    title: 'Google Summer of Code (GSoC) 2026 Developer Intern',
    company: 'Google',
    companyLogo: 'bi-google',
    badgeColor: '#ea4335',
    bgColor: '#fef2f2',
    borderColor: '#fee2e2',
    ...
    description: 'Work with open-source mentor organizations on real-world production codebases in Python, C++, Java, and Go.',
    skills: ['Python', 'C++', 'Java', 'Git & Open Source', 'Data Structures'],
    eligibility: 'Enrolled Students & Recent Graduates',
    recommendedCourse: 'Python Programming / Java Fundamentals'
  },
  {
    id: 'ext-int-2',
    title: 'Microsoft Explore Software Engineer Internship Program',
    company: 'Microsoft',
    companyLogo: 'bi-microsoft',
    badgeColor: '#0078d4',
    bgColor: '#eff6ff',
    borderColor: '#dbeafe',
    category: 'Software Engineering',
    stipend: '$4,000 / month + Housing',
    duration: '12 Weeks',
    locationType: 'Hybrid',
    location: 'Redmond, WA / Remote',
    deadline: 'March 2026',
    url: 'https://careers.microsoft.com/students/us/en/usexploreprogram',
    description: 'Rotational 12-week internship designed for first and second-year students exploring Software Engineering and Product Management.',
    skills: ['C# / Java', 'Object-Oriented Design', 'Data Structures', 'Team Communication'],
    eligibility: '1st & 2nd Year University Students',
    recommendedCourse: 'Java Programming Fundamentals'
  },
  {
    id: 'ext-int-3',
    title: 'Amazon Future Engineer Software Development Intern',
    company: 'Amazon',
    companyLogo: 'bi-amazon',
    badgeColor: '#ff9900',
    bgColor: '#fff7ed',
    borderColor: '#ffedd5',
    category: 'Software Engineering',
    ...
    description: 'Build scalable cloud microservices, AWS backend APIs, and distributed data pipelines alongside senior Amazon SDE mentors.',
    skills: ['Java', 'Python', 'AWS Cloud', 'REST APIs', 'SQL'],
    eligibility: 'Computer Science & STEM Students',
    recommendedCourse: 'Java / Python / Web Development'
  },
  {
    id: 'ext-int-4',
    title: 'GitHub Externship & Open Source Developer Fellow',
    company: 'GitHub',
    companyLogo: 'bi-github',
    badgeColor: '#24292e',
    bgColor: '#f8fafc',
    borderColor: '#e2e8f0',
    category: 'Full-Stack',
    ...
    location: 'Remote',
    deadline: 'April 2026',
    url: 'https://github.com/externship',
    description: 'Build enterprise developer tools, open-source GitHub Actions, and React/Node web modules with global developer mentorship.',
    skills: ['React', 'Node.js', 'Python', 'Git', 'CI/CD Pipelines'],
    eligibility: 'Active University Students',
    recommendedCourse: 'Full-Stack Web Development'
  },
  {
    id: 'ext-int-5',
    title: 'LinkedIn Tech, Product & AI Engineering Intern',
    company: 'LinkedIn',
    companyLogo: 'bi-linkedin',
    badgeColor: '#0a66c2',
    bgColor: '#f0f9ff',
    borderColor: '#e0f2fe',
    category: 'AI/ML',
    ...
    deadline: 'March 2026',
    url: 'https://careers.linkedin.com/students/Internships',
    description: 'Work on large-scale machine learning models, search recommendation engines, and high-concurrency web interfaces.',
    skills: ['Python', 'Machine Learning', 'Java', 'Data Analytics'],
    eligibility: 'Undergraduate & Graduate Students',
    recommendedCourse: 'Python Programming / Data Science'
  },
  {
    id: 'ext-int-6',
    title: 'Wellfound (AngelList) High-Growth Startup Internships',
    company: 'Wellfound Startups',
    companyLogo: 'bi-rocket-takeoff-fill',
    badgeColor: '#e11d48',
    bgColor: '#fff1f2',
    borderColor: '#ffe4e6',
    category: 'Full-Stack',
    stipend: '$1,000 - $2,500 / month',
    duration: '3 - 6 Months',
    locationType: 'Remote',
    location: 'Global Remote',
    deadline: 'Rolling Basis',
    url: 'https://wellfound.com/jobs',
    description: 'Direct internship openings at venture-backed AI, FinTech, and SaaS startups. Build real user-facing product features rapidly.',
    skills: ['React', 'Next.js', 'FastAPI', 'PostgreSQL', 'Tailwind CSS'],
    eligibility: 'All Skill Levels & Self-Taught Builders',
    recommendedCourse: 'Web Development / Python'
  },
  {
    id: 'ext-int-7',
    title: 'Unstop Global Corporate Hiring Challenges & Internships',
    company: 'Unstop',
    companyLogo: 'bi-trophy-fill',
    badgeColor: '#7c3aed',
    bgColor: '#f5f3ff',
    borderColor: '#ddd6fe',
    category: 'Frontend',
    stipend: '$500 - $1,500 / month',
    duration: '2 - 4 Months',
    locationType: 'Remote',
    location: 'Remote / India',
    deadline: 'Weekly Cycles',
    url: 'https://unstop.com/internships',
    description: 'Participate in corporate hackathons and developer challenges from Fortune 500 companies offering direct internship PPOs.',
    skills: ['JavaScript', 'React', 'Problem Solving', 'System Design'],
    eligibility: 'All University Students',
    recommendedCourse: 'Full-Stack / Python / Soft Skills'
  },
  {
    id: 'ext-int-8',
    title: 'HubSpot Digital Growth & SEO Marketing Internship',
    company: 'HubSpot',
    companyLogo: 'bi-diagram-2-fill',
    badgeColor: '#ff7a59',
    bgColor: '#fff7ed',
    borderColor: '#ffedd5',
    category: 'Marketing',
    ...
    description: 'Execute inbound marketing campaigns, SEO technical audits, content copywriting, and digital analytics funnels.',
    skills: ['SEO', 'Content Copywriting', 'Google Analytics', 'Inbound Funnels'],
    eligibility: 'Marketing & Mass Communication Students',
    recommendedCourse: 'Digital Marketing and SEO Mastery'
  }
];

export default function Internships({ userEmail, onShowToast }) {
  const [activeTab, setActiveTab] = useState('explore'); // 'explore' | 'external' | 'applications'
  const [loggedExternalAppIds, setLoggedExternalAppIds] = useState(() => {
    try {
      const saved = localStorage.getItem('skillsphere_logged_ext_internships');
  ...
  const handleLogExternalApp = (job) => {
    const nextSet = new Set(loggedExternalAppIds);
    nextSet.add(job.id);
    setLoggedExternalAppIds(nextSet);
    try {
      localStorage.setItem('skillsphere_logged_ext_internships', JSON.stringify(Array.from(nextSet)));
      const currXP = parseInt(localStorage.getItem('skillsphere_student_xp') || '450', 10);
      localStorage.setItem('skillsphere_student_xp', (currXP + 30).toString());
    } catch (e) {}

    if (onShowToast) {
      onShowToast('success', `Application logged for ${job.title} at ${job.company}! +30 XP awarded.`);
    }
  };
  ...
  return (
    <div className="fade-in-quick text-start">
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        {/* Tab Switchers */}
        <div className="bg-light p-1 rounded-pill border d-flex gap-1 flex-wrap">
          <button
          ...
          >
            <i className="bi bi-compass me-1"></i> Internal Openings ({jobs.length})
          </button>
          <button
            className={`btn btn-sm rounded-pill px-4 fw-bold ${activeTab === 'external' ? 'btn-primary text-white shadow-sm' : 'btn-light text-muted'}`}
            onClick={() => setActiveTab('external')}
          >
            <i className="bi bi-globe2 me-1"></i> External Opportunities Hub ({EXTERNAL_INTERNSHIPS.length})
            <span className="badge bg-warning text-dark rounded-pill ms-1" style={{ fontSize: '0.68rem' }}>GLOBAL PROGRAMS</span>
          </button>
          <button
      ...
      {/* TAB 1: EXPLORE INTERNAL OPENINGS */}
      {activeTab === 'explore' && (
        <>
          {/* Search & Filter Bar */}
              ...
              {filteredJobs.map(job => {
                ...
                return (
                  <div key={job.id} className="col-lg-6">
                    <div className="card border-0 shadow-sm rounded-4 p-4 h-100 bg-white border hover-lift">
                      <div className="d-flex justify-content-between align-items-start mb-3">
                        <div className="d-flex gap-3 align-items-center">
                          <div className="rounded-4 bg-success-subtle text-success p-3 d-flex align-items-center justify-content-center fw-bold fs-4" style={{ width: '54px', height: '54px' }}>
                            {job.company ? job.company.charAt(0).toUpperCase() : 'C'}
                          </div>
                          <div>
                            <h5 className="fw-bold text-dark mb-0">{job.title}</h5>
                            <small className="text-muted fw-semibold">{job.company}</small>
                          </div>
                        </div>
                        {applied && (
                          <span className={`badge rounded-pill px-3 py-2 fw-bold ${getStatusBadgeClass(appData?.status)}`}>
                      ...
                      <div className="d-flex gap-2 mb-3 flex-wrap">
                        {job.requiredSkills && job.requiredSkills.map((sk, i) => (
                          <span key={i} className="badge bg-light text-dark border rounded-pill px-3 py-1 small">
                            {sk}
                          </span>
                        ))}
                      </div>

                      <div className="d-flex align-items-center justify-content-between pt-3 border-top text-muted small flex-wrap gap-2">
                        <div className="d-flex gap-3">
                          <span><i className="bi bi-geo-alt text-danger me-1"></i>{job.locationType || 'Remote'}</span>
                          <span><i className="bi bi-cash-stack text-success me-1"></i>{job.stipend || 'Unpaid'}</span>
                          <span><i className="bi bi-calendar3 text-warning me-1"></i>{job.duration || '3 Months'}</span>
                        </div>
                        {applied ? (
                          <button className="btn btn-light btn-sm rounded-pill fw-bold text-muted border" disabled>
                            <i className="bi bi-check-circle-fill text-success me-1"></i> Applied
                          </button>
                        ) : (
                          <button 
      ...
      {/* TAB 2: EXTERNAL GLOBAL OPPORTUNITIES HUB */}
      {activeTab === 'external' && (
        <div className="mb-5">
          {/* External Header Bar */}
            ...
            <div className="row g-3 align-items-center">
              <div className="col-lg-7">
                <h5 className="fw-bold text-dark mb-1 d-flex align-items-center gap-2">
                  <i className="bi bi-globe2 text-primary fs-4"></i>
                  Top Enterprise & Global Tech Fellowships
                </h5>
                <p className="text-muted small mb-0">Explore verified internship & developer fellowship programs from Google, Microsoft, Amazon, GitHub, LinkedIn, Wellfound startups, and Unstop.</p>
              </div>
              <div className="col-lg-5 d-flex gap-2 justify-content-end flex-wrap">
                {['ALL', 'Software Engineering', 'Full-Stack', 'AI/ML', 'Marketing'].map(cat => (
                  <button
                    key={cat}
                    onClick={() => setSelectedCategory(cat)}
                    className={`btn btn-xs rounded-pill px-3 fw-bold ${selectedCategory === cat ? 'btn-dark text-white' : 'btn-light border text-muted'}`}
                    style={{ fontSize: '0.78rem' }}
                  >
                    {cat}
                  </button>
          ...
          <div className="row g-4">
            {EXTERNAL_INTERNSHIPS
              ...
              .map(item => {
                const isLogged = loggedExternalAppIds.has(item.id);
                  ...
                  <div key={item.id} className="col-lg-6">
                    <div 
                      ...
                      style={{ 
                        ...
                        borderLeft: `5px solid ${item.badgeColor}`
                      }}
                    >
                      <div className="d-flex justify-content-between align-items-start mb-3">
                        <div className="d-flex align-items-center gap-3">
                          <div 
                            ...
                            style={{ backgroundColor: item.badgeColor, width: '54px', height: '54px' }}
                          >
                            <i className={`${item.companyLogo} fs-2`}></i>
                          </div>
                          <div>
                            <span className="badge rounded-pill fw-bold px-3 py-1 mb-1" style={{ backgroundColor: `${item.badgeColor}20`, color: item.badgeColor }}>
                              {item.company}
                            </span>
                      ...
                      <div className="mb-2">
                        <small className="text-success fw-bold d-flex align-items-center gap-1">
                          <i className="bi bi-book-half"></i> Recommended for: {item.recommendedCourse}
                        </small>
                      </div>
                      ...
                      <div className="d-flex gap-2 mb-3 flex-wrap">
                        {item.skills.map((sk, idx) => (
                          <span key={idx} className="badge bg-white text-secondary border rounded-pill px-3 py-1 small">
                            <i className="bi bi-check2-circle me-1 text-success"></i>{sk}
                          </span>
                        ))}
                      </div>

                      <div className="d-flex align-items-center justify-content-between pt-3 border-top text-muted small flex-wrap gap-2 mb-3">
                        <span><i className="bi bi-cash-stack text-success me-1"></i>{item.stipend}</span>
                        <span><i className="bi bi-calendar3 text-warning me-1"></i>{item.duration}</span>
                        <span><i className="bi bi-geo-alt text-danger me-1"></i>{item.locationType} ({item.location})</span>
                      </div>
                      ...
                      <div className="d-flex gap-2">
                        <a
                          ...
                          style={{ backgroundColor: item.badgeColor, textDecoration: 'none' }}
                        >
                          <i className="bi bi-box-arrow-up-right"></i>
                          Apply on Official Portal
                        </a>
                        <button
                          onClick={() => handleLogExternalApp(item)}
                          disabled={isLogged}
                          ...
                          title="Log external application to earn XP"
                        >
                          <i className={`bi ${isLogged ? 'bi-check-all text-success' : 'bi-award'}`}></i>
                          {isLogged ? 'Applied' : '+30 XP'}
                        </button>
                      </div>
                    </div>
                  </div>
