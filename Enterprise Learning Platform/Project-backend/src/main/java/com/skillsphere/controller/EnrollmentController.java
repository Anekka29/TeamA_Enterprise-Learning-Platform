...
public class EnrollmentController {
    ...
    @GetMapping("/mentor/enrollments")
    public ResponseEntity<List<EnrollmentResponse>> getMentorEnrollments() {
        return ResponseEntity.ok(enrollmentService.getMentorEnrollments());
    }
