...
const DEFAULT_MENTOR_COURSES = [
  { id: 'c_fullstack_dev', title: 'Full-Stack Web Development & Microservices' },
  { id: 'c_java_backend', title: 'Java Backend & Microservices Masterclass' },
  { id: 'c_react_arch', title: 'Advanced React 18 & Modern UI Engineering' },
  { id: 'c_dsa_system', title: 'Data Structures, Algorithms & System Design' }
];
...
export default function SessionScheduler({ mentorEmail, onShowToast }) {
  ...
  useEffect(() => {
    ...
    CourseService.getMentorCourses()
      .then(res => {
        ...
        if (list.length > 0) {
          ...
          // Fallback to published courses or localStorage/default
    ...
    function useDefaultCourses() {
      ...
      setMentorCourses(DEFAULT_MENTOR_COURSES);
      setNewSession(prev => ({ ...prev, courseId: DEFAULT_MENTOR_COURSES[0].id }));
    }
