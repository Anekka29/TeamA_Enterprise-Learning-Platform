...
export default function StudentCourseDetails() {
  ...
  const [showPlayer, setShowPlayer] = useState(searchParams.get('player') === 'true');

  useEffect(() => {
    if (searchParams.get('player') === 'true') {
      setShowPlayer(true);
    }
  }, [searchParams]);
  ...
  if (error || !course) {
    return (
      <ErrorOverlay
        ...
        message="The requested course could not be found or loaded. Please check back later or select another course."
        buttonText="Back to Dashboard"
        buttonLink={ROUTES.STUDENT_DASHBOARD}
      />
    );
  }
