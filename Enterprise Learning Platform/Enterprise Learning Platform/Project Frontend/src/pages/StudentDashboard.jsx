                  ...
                  <div className="card border-0 shadow-sm rounded-4 p-4 mb-4 text-start bg-white">
                    ...
                    <div className="p-3 bg-light rounded-4 border d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                      ...
                      <button
                        ...
                        onClick={() => navigate(`/student-dashboard/courses/${continueLearningCourse.courseId || continueLearningCourse.id}?player=true`)}
                      >
                      ...
                      <div className="p-4">
                        ...
                        {(course.progress || 0) >= 100 ? (
                          ...
                          <button
                            ...
                            style={{ fontSize: '0.85rem' }}
                            onClick={() => navigate(`/student-dashboard/courses/${course.courseId || course.id}?player=true`)}
                          >
